...
public class OpenAiGptReviewEngine implements AiReviewEngine {
  ...
  public OpenAiGptReviewEngine(ChatClient.Builder chatClientBuilder, ObjectMapper objectMapper) {
